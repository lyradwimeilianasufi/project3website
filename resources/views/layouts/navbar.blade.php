    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center space-x-4">
                ...
                <!-- Assistant Link -->
                <a href="{{ route('assistant') }}" class="relative text-gray-700 hover:text-blue-600" title="AI Assistant">
                ...
                <div class="relative">
                    ...
                    <div id="profileDropdown" class="dropdown-menu">
                        <div class="py-2">
                            ...
                            <!-- Assistant Link in Dropdown -->
                            <a href="{{ route('assistant') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
