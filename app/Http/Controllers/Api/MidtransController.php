...
class MidtransController extends Controller
{
    ...
    {
        Log::info('🎯 Midtrans Notification Callback Received:', $request->all());
        ...
        try {
            ...
            Log::info("🔄 Processing transaction: {$orderId}, Status: {$transactionStatus}");
            ...
            Log::info("✅ Transaction {$orderId} updated to: {$transaction->status}");
    ...
    {
        Log::info('🔗 Midtrans Redirect Received', $request->all());
        ...
        // Return JSON response untuk Flutter
        return response()->json([
            'success' => true,
            'order_id' => $orderId,
